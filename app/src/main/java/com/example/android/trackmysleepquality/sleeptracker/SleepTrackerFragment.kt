...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val viewModel: SleepTrackerViewModel = ViewModelProviders.of(this, sleepTrackerViewModelFactory).get(SleepTrackerViewModel::class.java)
        binding.lifecycleOwner = this
        binding.trackerModel = viewModel

        viewModel.navigateSleepQuality.observe(viewLifecycleOwner, Observer { night ->
            night?.let {
